...
class MassiveDataSource(MarketDataSource):
    ...
    Error handling:
      - Any poll failure is logged and retried on the next interval.
      - Individual malformed snapshots are skipped; others are still processed.
      - The cache retains last-known prices if polling fails.
    """
    ...
    def _fetch_snapshots(self) -> list:
        ...
        return self._client.get_snapshot_all(  # type: ignore[union-attr]
