...
class GBMSimulator:
    ...
    def __init__(
        ...
        # Batch-initialize all starting tickers, then build Cholesky once
    ...
    def _pairwise_correlation(t1: str, t2: str) -> float:
        ...
        Correlation structure:
          - TSLA with anything:   0.3 (checked first — TSLA is in tech but independent)
          - Same tech sector:     0.6
          - Same finance sector:  0.5
          - Cross-sector/unknown: 0.3
        """
        # TSLA is in the tech set but behaves independently — check before sector logic
...
class SimulatorDataSource(MarketDataSource):
    ...
    def get_tickers(self) -> list[str]:
        return self._sim.get_tickers() if self._sim is not None else []
